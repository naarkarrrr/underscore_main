google.maps.__gjsload__('overlay', function(_) {
    var BD = function(a) {
        ...
        pna = function(a, b) {
            ...
            a.bindTo("panes", f);
            e = () => _.Zm(d.Eh);
            c.Rh = [_.rk(a, "panes_changed", e), _.rk(f, "zoom_changed", e), _.rk(f, "offset_changed", e), _.rk(b, "projection_changed", e), _.rk(f, "projectioncenterq_changed", e)];
            _.Zm(d.Eh);
            b instanceof _.Ok ? (_.yl(b, "Ox"), _.wl(b, 148440)) : b instanceof _.Tl && (_.yl(b, "Oxs"),
                _.wl(b, 181451))
        },
        una = function(a) {
            if (a) {
                var b = a.getMap();
                if (qna(a) !== b && b && b instanceof _.Ok) {
                    const c = b.__gm;
    ...
    DD.Xk = function(a) {
        if (a) {
            var b = a.getMap();
            (CD(a).wB || null) !== b && (b && pna(a, b), CD(a).wB = b)
        }
    };
    DD.sl = function(a) {
        const b = CD(a);
    ...
    _.jk("overlay", {
        Pz: function(a) {
            if (a) {
                ...
                (0, ED.sl)(a);
                var b = a.getMap();
                b && (b instanceof _.Ok ? (0, ED.Xk)(a) : (0, DD.Xk)(a))
            }
        },
        ...
        preventMapHitsAndGesturesFrom: a => {
            a.addEventListener("click", _.pk);
            a.addEventListener("contextmenu", _.pk);
            a.addEventListener("dblclick", _.pk);
            a.addEventListener("mousedown", _.pk);
            a.addEventListener("mousemove", _.pk);
            a.addEventListener("MSPointerDown",
                _.pk);
            a.addEventListener("pointerdown", _.pk);
            a.addEventListener("touchstart", _.pk);
            a.addEventListener("wheel", _.pk)
        }
    });
});